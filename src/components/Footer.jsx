...
const navigation = {
    ...
    support: [
      ...
      { name: 'Gratis Downloads 🔥', href: '/#downloads' },
    ...
    company: [
      ...
      { name: 'Call buchen', href: 'https://calendly.com/tilltech/tilltech-infogesprach' },
    ...
    social: [
      {
        name: 'Facebook',
        href: 'https://www.facebook.com/profile.php?id=100089148592975',
        icon: (props) => (
      ...
      {
        name: 'GitHub',
        href: 'https://github.com/VrhovacDavid',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
